...
namespace Control
{
    internal class DBConnector:Controller
    {
        ...
        {
            string dbFile = @"Data source = Z:\AU Courses\JTS\JTS.db; Version=3;"; //data source will change when finalizing the project
        ...
        {
            string dbFile = @"Data source = Z:\AU Courses\JTS\JTS.db; Version=3;";
